		...
		<div className={clsx(styles.container, 'container')} id='team'>
			...
			<div className={styles.cards}>
				<div className={styles.card} onClick={() => goToProfile('bilol')}>
					<img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSxys3YcMIKBtHrEwQ3JdVz-YiNNSDlXhYRVw&s' />
				...
				<div className={styles.card} onClick={() => goToProfile('biimyrza')}>
					<img src='https://i1.sndcdn.com/avatars-wtBAX6qgXtY0yPad-R1QPuA-t1080x1080.jpg' />
				...
				<div className={styles.card} onClick={() => goToProfile('oyatillo')}>
					<img src='https://pyxis.nymag.com/v1/imgs/059/056/4fe6fb3a2aa9222855627e5ef384156369-6-22-Epstein.1x.rsquare.w1400.jpg' />
